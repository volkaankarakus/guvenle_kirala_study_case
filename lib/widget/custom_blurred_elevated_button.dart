...
class CustomBlurredElevatedButton extends StatefulWidget {
  ...
  final Widget child;
  const CustomBlurredElevatedButton(
  ...
  @override
  State<CustomBlurredElevatedButton> createState() =>
      _CustomBlurredElevatedButtonState();
}

class _CustomBlurredElevatedButtonState
    extends State<CustomBlurredElevatedButton> {
